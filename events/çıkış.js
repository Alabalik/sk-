...
module.exports = async member => {  
  ...
  const background = await Canvas.loadImage('https://media.discordapp.net/attachments/758724044983107585/761940427896913970/New_Project_2.png?width=841&height=474');
