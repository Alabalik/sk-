...
module.exports = async member => {
  ...
  const background = await Canvas.loadImage('https://media.discordapp.net/attachments/758724044983107585/761940271608889344/New_Project_1.png?width=841&height=474');
